...
VALUES (100000, 100004, current_date + interval '+10:00' hour to minute),
       (100001, 100004, current_date + interval '+11:00' hour to minute ),
       (100002, 100006, current_date + interval '+16:00' hour to minute );
