...
@NamedQueries({
        ...
        @NamedQuery(name = Dish.ALL_BY_DATE, query = "SELECT d FROM Dish d JOIN FETCH d.restaurant WHERE d.date = :date ORDER BY d.restaurant.name, d.name"),
})
@Entity
...
public class Dish extends AbstractNamedEntity {
    ...
    public static final String ALL_BY_RESTAURANT = "Dish.getAllByRestaurant";
    public static final String ALL_BY_DATE = "Dish.getAllWithRestaurants";
